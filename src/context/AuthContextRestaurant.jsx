...
// 	const [userType, setUserType] = useState(null); // 'guest' or 'restaurant'
// 	const [userToken, setUserToken] = useState(null);
// 	const [role, setRole] = useState(null); // Add role for user
// 	const [loading, setLoading] = useState(true); // Loading state
...
// 			// Derive role from the storedUser object
// 			setRole(storedUser.role || null); // Ensure role exists in your user data
// 		}
...
// 		setUserType(type);
// 		setUserToken(userData.token);
// 		setRole(userData.data.role || null); // Set role during login
